---
title: "State Convention Resolutions"
description: "Resolutions and amendments being presented to State Delegates for a vote."
date: 2026-04-23
draft: false
categories: ["state"]
pinned: false
...
The proposed change can be found [here](https://docs.google.com/document/d/1UH5irut3memLnJNlNxY5eBMsygYGIsYqw6tYfsjw2f0/edit?tab=t.0).
...
H. In the event that three <u>**(3)**</u> or more candidates are nominated for the same office, the convention may use multiple ballots or preference voting to choose Party nominees. The State Party Central Committee shall certify the method of election for the State Convention at least <u>**six (**</u>6<u>**)**</u> months prior to the convention. In the case of multiple ballots, more than one <u>**(1) candidate may be eliminated in each round., provided that If the number of votes received by any candidate is greater than the sum of the votes of all the candidates receiving fewer votes, all those candidates receiving fewer votes will be eliminated.**</u> ~~sum of the votes received by the candidates to be eliminated does not exceed the number of votes received by the next highest candidate, and that at least two candidates remain on the ballot.~~ <u>**In any round of voting where two (2) or more candidates tie in getting the least number of votes, and are not eliminated using the previous rule, all tied candidates will be eliminated, except where the combined votes of the tied candidates are greater than 40%, then no candidates shall be eliminated.**</u> The two <u>**(2)**</u> top candidates shall participate in the final ballot.
...
The proposed change can be found [here](https://docs.google.com/document/d/1uZ7Eork3WAmfoWtbJnw9ibzbRDrsLONLdpNmNA6b9DQ/edit?tab=t.0).
...
C. Membership  
<u>**1.**</u> Party membership is open to any resident of the State of Utah who registers to vote as a Republican and complies with the Utah Republican Party Constitution and bylaws, and membership may be further set forth in the Utah Republican Party Bylaws.  
~~D.~~  2. Eligibility to run for office. A person seeking to run as a ~~state~~ Republican candidate for partisan elected office must demonstrate continuous voter registration with Republican Party affiliation for ~~the previous year.~~ <u>**one year prior to filing to run for an elected office.**</u>
...
The proposed change can be found [here](https://docs.google.com/document/d/1ruBmpqWC54kuNH7lw1b2D7psrYclf5bHiIN1vtrWLdM/edit?tab=t.0).
...
The proposed change can be found [here](https://docs.google.com/document/d/1ML1AkUFFD8IaHV2Sn2HCZhe5oZ_7A8najxb20RjB3aM/edit?tab=t.0).
...
A.  
&emsp;1. Pursuant to the requirements of Utah State Election Law, the following ~~listings~~ <u>**names**</u> shall be made available to the public by the State Party and each County Party within the time frames specified:  
&emsp;&emsp;a. All officers of that party, within 7 days of their election or replacement;  
&emsp;&emsp;b. All persons holding membership on any governing bodies of that Party, within 14 days of their selection or replacement;  
&emsp;&emsp;c. Any other persons holding elected or appointed positions**, including delegates,** within that party, within 14 days of their election or appointment;  
&emsp;&emsp;d. All persons who have filed as Republicans for partisan public elective office, whose jurisdiction would include or be contained in that party’s boundaries, within 7 days of the filing deadline;  
&emsp;&emsp;e. All persons who have been nominated as Republican candidates for public office by that Party, within 7 days of their nomination or replacement.  
&emsp;2. ~~All such listings shall include, at a minimum, the name, address, and phone number, where available, of each person listed.~~  
&emsp;~~3.~~ <u>**2.**</u> The State Party shall <u>**maintain**</u> ~~make available to the public~~, within 14 days of the caucuses, a complete statewide listing of all Republican state delegates. Each county party shall <u>**maintain**</u> ~~make available to the public~~, within 14 days of the caucuses, a complete countywide listing of the Republican state and county delegates residing in that county. Changes in delegate status shall be reflected in the listings within 14 days of their occurrence.  
&emsp;~~4.~~ <u>**3.**</u> All delegate listings shall include, at a minimum, the name, precinct, Utah House district, Utah Senate district, Congressional district, address, phone number, <u>**email**</u> and basis of eligibility of each delegate (e.g., election in the precinct caucus, election after the caucuses to fill an unfilled seat, or appointment to fill a vacancy occurring after the caucuses).  
&emsp;~~5.~~ <u>**4.**</u> The State Party and/or county parties may charge up to, but not more than, the direct cost of the medium by which a listing <u>**or a method**</u> is made available to the person(s) so requesting~~,~~**.** ~~provided that any listing made available by electronic mail or on the Internet shall be made available at no charge.~~ <u>**Officially declared candidates currently pursuing office through the convention system will not be charged fees for access to a method to contact delegates relevant to their race by the State or any County Party.**</u>  
&emsp;<u>**5. Nothing in this Section precludes the requirement that State and County Party leadership maintain neutrality towards Republican candidates.**</u>
...
The proposed change can be found [here](https://docs.google.com/document/d/12sGKzS-3RUipACwAQbRc3EJfdi4ZeRqmiSoN2zbYA7A/edit?tab=t.0).
...
The proposed change can be found [here](https://docs.google.com/document/d/19DqrMP94dRN0VzVdD2Gv2R5p-NVz50zSYqfSGCQoUqw/edit?tab=t.0).
...
The proposed change can be found [here](https://docs.google.com/document/d/1K29PlUK5Q2eLkEuEL8xT8nGZGV_k9N7C_bCJPXXPwOg/edit?tab=t.0).
...
- Utah used to have a Secretary of State.
- Then the State got nervous, because the Secretary would be the #2 in charge after the Governor, and what if a Democrat got elected?
- So they got rid of it and added a Lt. Gov.
- We should go back to a secretary of state.
- A Secretary of State is focused on elections.
- We want someone who doesn't have other work going on.
- A Secretary of State is an elected position, providing direct accountability to the voters. The Lt. Gov. does not have that. They're selected by the governor. We want someone that we trust overseeing our initiatives and referenda. It might be worth the extra $150k a year to keep someone around for that.
- The Lt. Gov. is not a neutral party, but a Secretary of State would be.
...
The proposed change can be found [here](https://docs.google.com/document/d/1d57dgPyCaSJwVeCjmyHLt8WlCZf9t_-wODjxkRkMoCw/edit?tab=t.0).

**Sponsor:** Kaye Pratt

### Summary

- Basically rebukes the judicial branch stating that their actions related to redistricting constituted overreach
- Reinforces the right of the Legislature to establish district boundaries
...
The proposed change can be found [here](https://docs.google.com/document/d/1gD886Rp6AkOeRCVpBPCRFqPrTaQtHBrIB7oB2aqpa5s/edit?tab=t.0).

**Sponsor:** Bob McEntee

### Summary

- This is proposed as a national security issue
...
The proposed change can be found [here](https://docs.google.com/document/d/113q-r1CC3f7nL1qumzkb3KCa816lQcY50yeoepGnRXc/edit?tab=t.0).

**Sponsor:** Lowell Nelson

### Summary

- There are many ways to skin a cat: this is another way around SB 54, which mandates two paths to the ballot (allows for signature gathering to get you on the ballot rather than the only path being winning the Party nomination at Convention).
- There are two kinds of parties in Utah Code: Registered Political Parties (RPP) and Qualified Political Parties (QPP).
- The requirements for registered parties in [Utah Code](https://le.utah.gov/xcode/Title20A/Chapter9/20A-9-S409.html) is currently that you must hold a primary, or none of your candidates will appear on the general ballot.
- This resolution suggests we change this state law for an RPP to allow an RPP to not participate in a primary but still be on the ballot.
- The party could then choose to be a registered party, decide nominees at convention, and not participate in a primary. Then our convention pick goes directly to the general election ballot.
- A challenge to lawmakers: "Let's see if our candidates who claim to love the caucus system so much but secretly like signature gathering have the guts to implement this change."
